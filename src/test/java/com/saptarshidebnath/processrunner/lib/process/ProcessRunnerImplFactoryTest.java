...
public class ProcessRunnerImplFactoryTest {
    ...
    public void startProcess()
        ...
        final int response = ProcessRunnerFactory.startProcess(getDefaultInterpreter(), getInterPreterVersion());
    ...
    public void getProcessLessDetailed()
        ...
        final Type listTypeOuputArray = new TypeToken<List<Output>>() {
        }.getType();
